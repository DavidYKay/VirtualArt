...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SimpleArt'
        db.create_table('virtualart_simpleart', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='', max_length=100)),
            ('coordinate', self.gf('django.db.models.fields.FloatField')(default=0)),
        ))
        db.send_create_signal('virtualart', ['SimpleArt'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'SimpleArt'
        db.delete_table('virtualart_simpleart')
